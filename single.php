...
?>
  ...
  <!--/kizi-->
                        <div id="Feedly">
                                <div id="FeedlyTitle">
                                        <h4 class="kanren">RSS登録して頂けるとモチベーションになります♪</h4>
                                </div>
                                <div id="FeedlyContent" style="text-align:center";>
                                        <a href='http://cloud.feedly.com/#subscription%2Ffeed%2Fhttp%3A%2F%2Fpickslife.me%2Ffeed'  target='blank'><img id='feedlyFollow' src='http://s3.feedly.com/img/follows/feedly-follow-rectangle-volume-big_2x.png' alt='follow us in feedly' width='300' height='128'></a>               </div>
                        </div>
  <!--/関連記事-->
  <div style="padding:20px 0px;">
    <?php get_template_part('ad');?>
